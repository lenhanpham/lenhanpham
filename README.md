...
- **[OpenQuantum](https://github.com/lenhanpham/OpenQuantum)**: An opensource quantum chemical program in Rust. Implements Quantum chemical methods HF and DFT in Rust (Long-term project under development). 
